...
import static com.hhplus.hhplusconcertservice.domain.common.exception.ErrorCode.CONCERT_IS_NOT_FOUND;
...
public class ConcertService {
    ...
    public ConcertReservationInfo reserveSeat(ReservationCommand.Create command) {
        ...
        // 4. 예약 테이블 저장
        ConcertReservationInfo reservationInfo = command.from(seat, concertDate);
    ...
    public void completeReservation(ReservationCommand.Complete command) {
        ...
        concertValidator.checkSavedReservation(completeReservation, "예약 완료에 실패하였습니다");
