...
import com.hhplus.hhplusconcertservice.domain.concert.*;
import com.hhplus.hhplusconcertservice.domain.concert.ConcertReservationInfo.ReservationStatus;
...
import static com.hhplus.hhplusconcertservice.domain.concert.Seat.SeatStatus.AVAILABLE;
import static com.hhplus.hhplusconcertservice.support.utils.DateUtils.getLocalDateTimeToString;
...
public class ConcertRepositoryImpl implements ConcertRepository {
    ...
    public Optional<Place> savePlace(Place place) {
        ...
        return Optional.of(placeEntity.from());
    }
    ...
    public boolean checkAlreadyReserved(Long concertId, Long concertDateId, int seatNumber) {
        return reservationJpaRepository.existsByConcertIdAndConcertDateIdAndSeatNumberAndStatusIsNot(concertId,
                concertDateId, seatNumber, ReservationStatus.CANCEL.CANCEL);
    }
...
//                .findSeatWithPessimisticLock(concertDateId, seatNumber);
    ...
    public Optional<ConcertReservationInfo> saveReservation(ConcertReservationInfo reservation) {
        ConcertReservationEntity reservationEntity = reservationJpaRepository.save(
                ConcertReservationEntity.from(reservation));
