package com.hhplus.hhplusconcertservice.interfaces.controller.reservation;
...
import com.hhplus.hhplusconcertservice.interfaces.controller.reservation.dto.CancelReservationDto;
import com.hhplus.hhplusconcertservice.interfaces.controller.reservation.dto.ReservationDto;
import com.hhplus.hhplusconcertservice.support.aop.TraceLog;
...
public class ReservationController {
    ...
    public ApiResultResponse<ReservationDto.Response> reserveSeat(@RequestBody @Valid ReservationDto.Request request) {
        ...
        return ApiResultResponse.ok(ReservationDto.Response.of(concertService.reserveSeat(request.toCreateCommand())));
    }
    ...
    public ApiResultResponse<List<ReservationDto.Response>> getMyReservations(@PathVariable(name = "userId") @NotNull Long userId) {
        ...
        return ApiResultResponse.ok(
                concertService.getMyReservations(userId).stream()
    ...
    public ApiResultResponse<String> cancelReservation(@PathVariable(name = "reservationId") @NotNull Long reservationId,
        ...
        concertService.cancelReservation(request.toDeleteCommand(reservationId));
